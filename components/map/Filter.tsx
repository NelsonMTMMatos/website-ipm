...
const Filter = ({ setActivities, setFilterIcon, setFilterOpen}: Props) => {
  ...
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50
                    w-3/4 max-w-xs flex flex-col items-center bg-white p-4 rounded-2xl shadow-md">
      <div className=' w-full flex items-center justify-end' onClick={() => setFilterOpen(false)}>
        <RxCross2  size={24}/>
      </div>
